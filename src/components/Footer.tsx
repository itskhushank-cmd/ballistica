...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-black/50 backdrop-blur-xl py-4 mt-auto">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col items-center justify-center space-y-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg font-black tracking-tighter text-white uppercase">Ballistica</span>
          </div>
          
          <div className="text-center space-y-1">
            <p className="text-[9px] font-bold text-lab-muted uppercase tracking-[0.5em] text-glow">
          ...
          <div className="pt-4 border-t border-white/5 w-full text-center">
            <p className="text-[7px] text-slate-700 uppercase tracking-[0.2em]">
